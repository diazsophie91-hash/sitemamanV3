...
<main class="page-qui-suis-je" id="main-content">
    ...
    <section class="qui-suis-je-introduction">
        ...
        <div class="qui-suis-je-contenu">
            ...
            <p>
                Depuis mon enfance, la nature a toujours occupé une place particulière dans ma vie. C’est un espace où je pouvais être au calme, m’émerveiller et simplement me sentir exister. Les plantes, les arbres, les animaux, les oiseaux… tout ce qui compose le vivant a toujours éveillé ma curiosité.
            </p>
            ...
            <p>
                En parallèle, mon côté spirituel avait besoin de développement et de compréhension également. Le Reiki est ainsi venu naturellement trouver sa place dans mon parcours, comme un autre chemin d’exploration, tourné davantage vers l’énergie, l’intériorité, l’harmonie et l’accompagnement de l’humain.
            </p>
    ...
    <?php foreach ($ordre_parcours as $parcours): ?>
            ...
            <section class="qui-suis-je-parcours qui-suis-je-nature">
                ...
                >
                    ...
                    <div class="qui-suis-je-contenu">
                        ...
                        <p>
                            La nature m’intéresse dans toute sa richesse : les plantes sauvages et la botanique, les arbres, les animaux, les traces et indices, la géologie, l’écologie… mais aussi l’histoire, que j’aime particulièrement.
                        </p>
                        ...
                        <p>
                            Pour moi, être Guide-Nature, c’est avant tout <strong>transmettre</strong> : permettre à chacun d’apprendre, de s’émerveiller et de changer son regard sur la nature.
                        </p>
            ...
            <section class="qui-suis-je-parcours qui-suis-je-reiki">
                ...
                <div class="le-reiki-accordeon-contenu qui-suis-je-parcours-contenu">
                    ...
                    <div class="qui-suis-je-contenu">
                        ...
                        <p>
                            C’est dans cette recherche que j’ai découvert le Reiki.
                        </p>
                        ...
                        <p>
                            Puis, durant trois années, je me suis formée au <strong>Reiki Usui auprès de la Maître Reiki Dominique Pfeiffer</strong>.
                        </p>
        ...
        <img
            src="<?php echo esc_url(
                nature_reiki_asset_url('images/lignée-reiki.png')
            ); ?>"
            alt=""
        >
    </div>
    ...
    <section class="qui-suis-je-lien">
        ...
        <div class="qui-suis-je-contenu">
            ...
            <p>
                Pourtant, pour moi, ils sont profondément liés.
            </p>
    ...
    <section class="qui-suis-je-citation">
        ...
        <div class="qui-suis-je-citation-interieur">
            ...
            <p>
                « La vie, ce n’est pas d’attendre que les orages passent, c’est d’apprendre comment danser sous la pluie. » <span class="qui-suis-je-citation-auteur"><strong>- Sénèque</strong></span>
            </p>
