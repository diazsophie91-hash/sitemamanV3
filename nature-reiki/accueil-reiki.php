...
<section class="<?php echo esc_attr( $banniere['section_class'] ); ?>"<?php if ( $banniere['section_id'] ) : ?> id="<?php echo esc_attr( $banniere['section_id'] ); ?>"<?php endif; ?> aria-labelledby="<?php echo esc_attr( $banniere['aria_labelledby'] ); ?>">
